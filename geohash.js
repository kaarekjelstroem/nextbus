...
// 02/04/14: Kåre Kjelstrøm: The official verison of this library has a bug, which causes calculateAdjacent not to work!!
...
var GeoHash = (function () {
  ...
  return {
    ...
    calculateAdjacent: function (srcHash, dir) {
      console.log("calculateAdjacent:(" + srcHash + ", " + dir + ")");
      srcHash = srcHash.toLowerCase();
      var lastChr = srcHash.charAt(srcHash.length-1);
      var type = (srcHash.length % 2) ? 'odd' : 'even';
      var base = srcHash.substring(0, srcHash.length-1);
      if (BORDERS[dir][type].indexOf(lastChr)!=-1) {
          console.log("calculateAdjacent:inIf")
